...
namespace tinhphicongchung.com.library
{
    public class Files
    {
        ...
        public Files(string connection)
        {
        ...
        public async Task<Tuple<string, string>> InsertOrUpdate()
        {
            ...
            try
            {
                using (IDbConnection connection = new SqlConnection(_connectionString))
                {
                    ...
                    param.Add("@FileTypeId", this.FileTypeId, DbType.Int32);
                    if (!string.IsNullOrEmpty(this.Path))
                        param.Add("@Path", StringHelper.InjectionString(this.Path), DbType.String);
                    param.Add("@FileSize", this.FileSize, DbType.Int32);
                    if (!string.IsNullOrEmpty(this.ContentType))
                        param.Add("@ContentType", StringHelper.InjectionString(this.ContentType), DbType.String);
                    param.Add("@StatusId", this.StatusId, DbType.Byte);
                    param.Add("@FileId", this.FileId, DbType.Int32, ParameterDirection.InputOutput);
                    ...
                    await connection.ExecuteAsync("Files_InsertOrUpdate", param, commandType: CommandType.StoredProcedure);
                    
                    this.FileId = param.Get<int>("FileId");
        ...
        public async Task<Tuple<string, string>> Delete()
        {
            ...
            try
            {
                using (IDbConnection connection = new SqlConnection(_connectionString))
                {
                    ...
                    if (!string.IsNullOrEmpty(this.ActBy))
                        param.Add("@ActBy", this.ActBy, DbType.String);
                    param.Add("@FileId", this.FileId, DbType.Int32);
                    param.Add("@ActionStatus", dbType: DbType.String, direction: ParameterDirection.Output, size: 50);
                    param.Add("@ActionMessage", dbType: DbType.String, direction: ParameterDirection.Output, size: 250);
                    
                    await connection.ExecuteAsync("Files_Delete", param, commandType: CommandType.StoredProcedure);
        ...
        public async Task<Files> Get()
        {
            Files resultVar = new Files();
        ...
        public async Task<Tuple<List<Files>, int>> GetPage(DateTime dateFrom, DateTime dateTo, byte searchByDateType, int orderByClauseId, int pageIndex, int pageSize)
        {
            int rowCount = 0;
            List<Files> filesList = null;
            Tuple<List<Files>, int> resultVar = Tuple.Create(filesList, rowCount);
            ...
            try
            {
                using (IDbConnection connection = new SqlConnection(_connectionString))
                {
                    ...
                    filesList = await connection
                        .QueryAsync<Files>("Files_GetPage", param, commandType: CommandType.StoredProcedure)
                        as List<Files>;

                    rowCount = param.Get<int>("RowCount");

                    resultVar = Tuple.Create(filesList, rowCount);
                }
            }
            catch (Exception ex)
            {
        ...
        public static async Task<Files> Static_GetById(string actBy, int fileId)
        {
